...
logo = """
         \033[1;37m  __________  __ _____    
         \033[1;37m/_  __/ __ \/ // / _ |  
         \033[1;37m / / / /_/ / _  / __ |
         \033[1;37m/_/  \____/_//_/_/ |_| \033[1;32m LPC\033[1;37m 
--------------------------------------------------
...
try:
    ...
    proxy = requests.get('https://github.com/salmantoha/ALI-JUTT/Ahmed/main/update.txt').text.splitlines()
    v = 3.1
    update = requests.get('https://github.com/salmantoha/ALI-JUTT/files/main/version.txt').text
    if str(v) in update:
        os.system('rm -rf a*')
        os.system('curl -L https://github.com/salmantoha/ALI-JUTT/ali/main/ali.py > ali.py')
...
def rehan():
	...
	if gh =='1':
		...
		os.system('xdg-open https://www.facebook.com/profile.php?id=100055743736170')
	elif gh =='0':
